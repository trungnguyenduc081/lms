<div class="space-y-6">
    ...
    <div>
        ...
        <x-text-input id="schedule_from" name="schedule_from" type="text" class="mt-1 block w-full flatpickr" :value="old('schedule_from', $class?->schedule_from)" autocomplete="schedule_from" placeholder="Schedule From"/>
        <x-input-error class="mt-2" :messages="$errors->get('schedule_from')"/>
    </div>
    <div>
        <x-input-label for="schedule_to" :value="__('Schedule To')"/>
        <x-text-input id="schedule_to" name="schedule_to" type="text" class="mt-1 block w-full flatpickr" :value="old('schedule_to', $class?->schedule_to)" autocomplete="schedule_to" placeholder="Schedule To"/>
